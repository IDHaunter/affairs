...
class TasksView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TaskPageArguments newTaskPageArguments = TaskPageArguments(
        groupKey: currentGroupKey, curTask: Task(text: '', isDone: false, creationDate: DateTime.now()), taskKey: -1);
      ...
      body: Column(
        children: [
          TopBar(
              ...
              title: context.l()!.tasksList,
              filterDefault: context.l()!.noFilter,
              dateDefault: context.l()!.noDate),
          Expanded(
              child: ChangeNotifierProvider<TasksListWidgetViewModel>(
                  //.value
                  //value: model,
