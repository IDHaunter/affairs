...
class DioBaseViewModel extends ChangeNotifier {
  //любой http запрос оканчивается либо получением данных либо ошибкой
  //Базовая модель хранит статус выполнения запроса (isLoading) и ошибку по результату запроса (sError),
  //получение данных и их хранение реализуются во ViewModel которая, перед запросом и после меняет isLoading
  //чем нотифайерит View
